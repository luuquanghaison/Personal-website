...
profiles:
  - icon: at-symbol
    url: 'mailto:quanghaison.luu@stat.ubc.ca'
    label: E-mail Me
  # - icon: brands/x
  ...
  - icon: brands/github
    url: https://github.com/luuquanghaison/
...
education:
  - area: PhD in Statistics, Present
  ...
  - area: MSc in Statistics, 2023
    institution: Dalhousie University
  - area: BSc in Math, 2021
